...
<body>
<s:form id="domainForm" action="depot">
...
<%--     <td width="145"><s:select list="#depts" name="baseQuery.deptId" headerKey="-1" headerValue="--请选择--" listValue="name" listKey="id" cssClass="kuan"/></td> --%>
	...
	<td width="136"><a href="depot_input.action"><img src="images/can_b_02.gif" border="0"/></a></td>
  </tr>
</table>
  ...
  <table id="itemTable" width="100%"  border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
    ...
    <s:iterator value="pageResult.rows">
	    <tr align="center" bgcolor="#FFFFFF">
	      ...
	      <td><img src="images/icon_3.gif" /> <span style="line-height:12px; text-align:center;"><s:a class="xiu" href="javascript:updateDomain('depot',%{id})">修改</s:a></span> <img src="images/icon_04.gif" /> <span style="line-height:12px; text-align:center;"><s:a class="xiu" href="javascript:" onclick="deleteDomain('depot_delete.action',%{id},this)">删除</s:a></span></td>
	    </tr>
    </s:iterator>
  </table>
