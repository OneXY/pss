...
<html>
  ...
  <body>     
    ...
    <script type="text/javascript"><!--         
      ...
      function findChart(swf){
    	var myChart = new FusionCharts( "FusionCharts/"+swf+".swf", 
    		      ...
    		      myChart.setJSONUrl("stockincomeBillItem_chart2.action?${pageContext.request.queryString}");
    ...
    <input type="button" onclick="findChart(this.value)" value="Area2D"/>     
    <input type="button" onclick="findChart(this.value)" value="Bar2D"/>     
    ...
    <input type="button" onclick="findChart(this.value)" value="Pareto2D"/>     
