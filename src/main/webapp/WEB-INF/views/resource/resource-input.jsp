...
<div class="square-order">
  ...
  <tr bgcolor="#FFFFFF">
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr  bgcolor="#FFFFFF">
      <td width="22%" align="center" height="30">资源名称</td>
      <td width="29%">
        <s:textfield name="name" id="name"/>
      </td>
    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">方法</td>
      <td>
        <s:textfield name="method" size="38"/>
      </td>
    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">备注</td>
      <td>
        <s:textarea name="descs" rows="10" cols="30"/>
      </td>
    </tr>
  </table>
