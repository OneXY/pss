...
<body>
<s:form id="productForm" action="product_save.action" namespace="/" enctype="multipart/form-data">
...
<div class="square-order">
  ...
  <tr bgcolor="#FFFFFF">
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr  bgcolor="#FFFFFF">
      <td width="22%" align="center" height="30">产品名称</td>
      <td width="29%">
    ...
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">产品颜色</td>
      <td>
        <s:textfield name="color"/>
      </td>
    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">成本价格</td>
      <td>
    ...
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">类型列表</td>
      <td>
        <s:select id="parent" list="#allParents" name="types.parent.id" headerKey="-1"
         headerValue="--请选择--" listValue="name" listKey="id"/>
        <s:select id="children" list="#allChildrens" name="types.id" listValue="name" listKey="id"/>
      </td>
    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">品牌列表</td>
      <td>
      	<s:select list="#allBrands" name="brand.id" listKey="id" listValue="name"/>
      </td>
    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">单位列表</td>
      <td>
