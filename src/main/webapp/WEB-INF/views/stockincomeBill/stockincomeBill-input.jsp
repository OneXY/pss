...
<body>
<s:form id="stockincomeBillForm" action="stockincomeBill_save.action" namespace="/">
...
<div class="square-order">
  ...
  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
    ...
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">库管员</td>
      <td>
        <s:select name="keeper.id" list="#allKeepers" listValue="name" listKey="id"/>
      </td>
    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">仓库号</td>
      <td>
        <s:select name="depot.id" list="#allDepots" listValue="name" listKey="id"/>
      </td>
    </tr>
  </table>
