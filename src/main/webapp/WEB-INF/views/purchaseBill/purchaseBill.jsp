...
<script type="text/javascript">
	function auditor(id,src){
		$.get("purchaseBill_auditor.action",{"id":id},function(data){
			if(data=="此单成功审核"){
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="font-size:14px; font-weight:bold; font-family:"黑体";">
  ...
  <tr>
	...
	<td width="136"><a href="purchaseBill_input.action"><img src="images/can_b_02.gif" border="0"/></a></td>
  </tr>
</table>
	      ...
	      <td code="opreat">
	      	<s:if test="status==0">
			      ...
			      <span style="line-height:12px; text-align:center;">
			      	<s:a class="xiu" href="javascript:updateDomain('purchaseBill',%{id})">修改</s:a>
			      </span>
						<img src="images/icon_04.gif" />
						<span style="line-height:12px; text-align:center;">
							<s:a class="xiu" href="javascript:" onclick="deleteDomain('purchaseBill_delete.action',%{id},this)">删除</s:a>
						</span>
