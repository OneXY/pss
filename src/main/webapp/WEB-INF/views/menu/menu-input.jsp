...
<body>
<s:form id="menuForm" action="menu_save.action" namespace="/">
...
<div class="square-order">
  ...
  <tr bgcolor="#FFFFFF">
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr  bgcolor="#FFFFFF">
      <td width="22%" align="center" height="30">菜单名称</td>
      <td width="29%">
        <s:textfield name="name" id="name"/>
      </td>
    </tr>
	    <tr  bgcolor="#FFFFFF">
	      <td height="30" align="center">超链接</td>
	      <td>
	        <s:textfield id="url" name="url"/><div id="complexity1"></div>
	      </td>
	    </tr>
	    <tr  bgcolor="#FFFFFF">
	      <td height="30" align="center">图片地址</td>
	      <td>
	        <s:textfield id="icon" name="icon"/><div id="complexity2"></div>
	      </td>
	    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">上级菜单</td>
      <td>
