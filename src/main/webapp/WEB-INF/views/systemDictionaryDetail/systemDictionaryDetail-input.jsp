...
<body>
<s:form id="systemDictionaryDetailForm" action="systemDictionaryDetail_save.action" namespace="/">
...
<div class="square-order">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">类型名称</td>
      <td>
        <s:select name="types.id" list="#allTypes" headerKey="-1" headerValue="--请选择--" listValue="name" listKey="id"/>
      </td>
    </tr>
  </table>
