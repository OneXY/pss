...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="font-size:14px; font-weight:bold; font-family:"黑体";">
  ...
  <tr>
	...
	<td width="136"><a href="role_input.action"><img src="images/can_b_02.gif" border="0"/></a></td>
  </tr>
</table>
  ...
  <table id="itemTable" width="100%"  border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
    ...
    <s:iterator value="pageResult.rows">
	    <tr align="center" bgcolor="#FFFFFF">
	      ...
	      <td><img src="images/icon_3.gif" /> <span style="line-height:12px; text-align:center;"><s:a class="xiu" href="javascript:updateDomain('role',%{id})">修改</s:a></span> <img src="images/icon_04.gif" /> <span style="line-height:12px; text-align:center;"><s:a class="xiu" href="javascript:" onclick="deleteDomain('role_delete.action',%{id},this)">删除</s:a></span></td>
	    </tr>
    </s:iterator>
  </table>
