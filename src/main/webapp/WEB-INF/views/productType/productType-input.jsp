...
<body>
<s:form id="productTypeForm" action="productType_save.action" namespace="/">
...
<div class="square-order">
  ...
  <tr bgcolor="#FFFFFF">
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr  bgcolor="#FFFFFF">
      <td width="22%" align="center" height="30">名称</td>
      <td width="29%">
    ...
    <tr  bgcolor="#FFFFFF">
      ...
      <td>
        <s:textfield name="descs"/>
      </td>
    </tr>
    <tr  bgcolor="#FFFFFF">
      <td height="30" align="center">父类类型</td>
      <td>
        <s:select list="#allParentTypes" name="parent.id" listKey="id" listValue="name" headerKey="-1" headerValue="--请选择--"/>
      </td>
    </tr>
  </table>
